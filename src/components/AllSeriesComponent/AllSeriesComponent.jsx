...
const array = [
  {
    ...
    Description: "Whether you're a kid or a grown-up, a science fanatic or a political junkie, there's something for everyone on Tinyview. Follow to get alerts for new comics."
  },
  {
    Images: previewtwo,
    heading: "Subscribe",
    Description: "Support creators + unlock bonus panels + read unlimited comics + participate in the discussion. Cancel at any time."
  },
  {
    Images: preview,
    heading: "Earn and Use Influence Points",
    Description: "Can't subscribe but still want to support creators? Help us spread the word to your friends & family and earn Influence Points. Then use your points to unlock bonus panels and premium comics."
  }
];
